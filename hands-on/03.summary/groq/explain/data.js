...
window.EXPLAIN_DATA = {
  ...
  flow: [
    ...
    { step: 4, title: "입력 파일 읽기",
      label: "입력 파일 읽기",
      refs: ["read_text_file", "clean_markdown"],
    ...
    { step: 6, title: "청크 분할 및 요약",
      label: "청크 분할·요약",
      refs: ["summarize_text", "split_text"],
    ...
    { step: 8, title: "결과 저장 및 출력",
      label: "결과 저장·출력",
      refs: ["write_text_file", "print_usage_summary"],
