"""Multi-Query 기법 RAG 예제 (Query Transformation)

하나의 질문을 다양한 관점의 변형 질문 3개로 확장하고(원본 포함 4개),
각 질문으로 검색한 결과를 합쳐 중복 제거함으로써 검색 누락을 줄이는 예제임.

핵심 흐름: 원본 질문 → (LLM 변형) → 질문 4개 → 각각 검색 → 결과 병합·중복 제거 → 답변 생성
...
# ===========================================================================
# Multi-Query 기법 (이 예제의 핵심)
# ===========================================================================

def multi_query(llm, question: str) -> List[str]:
