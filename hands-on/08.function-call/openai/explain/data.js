...
window.EXPLAIN_DATA = {
  ...
  flow: [
    ...
    { step: 5, title: "메시지 구성", label: "메시지 구성", refs: ["build_chat_messages"],
    ...
    { step: 6, title: "OpenAI API 첫 호출", label: "OpenAI 첫 호출", refs: ["generate_response", "call_openai_chat"],
    ...
    { step: 7, title: "도구 호출 감지·실행", label: "도구 감지·실행", refs: ["run_tool_call", "execute_function"],
    ...
    { step: 8, title: "OpenAI API 재호출", label: "OpenAI 재호출", refs: ["generate_response"],
    ...
    { step: 9, title: "결과 표시", label: "결과 표시",
