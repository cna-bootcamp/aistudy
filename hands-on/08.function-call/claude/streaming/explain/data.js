...
window.EXPLAIN_DATA = {
  ...
  flow: [
    { step: 1, title: "앱 시작", label: "앱 시작", refs: ["main_func", "initialize_session_state"],
    ...
    { step: 5, title: "스트리밍 시작", label: "스트리밍 시작", refs: ["main_func", "stream_response"],
    ...
    { step: 6, title: "첫 스트림 · stop_reason 확인", label: "첫 스트림·stop_reason", refs: ["stream_response"],
    ...
    { step: 7, title: "도구 실행 (tool_use인 경우)", label: "도구 실행", refs: ["run_tool_calls", "execute_function"],
    ...
    { step: 8, title: "재호출 반복 (최대 5회)", label: "재호출 반복", refs: ["stream_response"],
    ...
    { step: 9, title: "결과 저장·사이드바 업데이트", label: "결과 저장·사이드바", refs: ["main_func", "display_sidebar"],
