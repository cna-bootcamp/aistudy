...
window.EXPLAIN_DATA = {
  ...
  flow: [
    { step: 1, title: "앱 시작",
      label: "앱 시작", refs: ["main","initialize_session_state"],
    ...
    { step: 2, title: "화면 구성",
      label: "화면 구성", refs: ["display_sidebar","display_chat_history"],
    ...
    { step: 4, title: "대화 이력 변환",
      label: "대화 이력 변환", refs: ["build_contents"],
    ...
    { step: 5, title: "Gemini 첫 호출",
      label: "Gemini 첫 호출", refs: ["generate_response","call_gemini_content"],
    ...
    { step: 6, title: "함수 호출 여부 판단",
      label: "함수 호출 판단", refs: ["generate_response"],
    ...
    { step: 7, title: "도구 실행 (수동 루프)",
      label: "도구 실행", refs: ["run_function_calls","execute_function"],
    ...
    { step: 8, title: "Gemini 재호출 + 루프",
      label: "Gemini 재호출·루프", refs: ["generate_response","run_function_calls"],
    ...
    { step: 9, title: "최종 답변 표시",
      label: "최종 답변 표시", refs: ["response_text"],
