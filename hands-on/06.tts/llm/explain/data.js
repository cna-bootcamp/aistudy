...
window.EXPLAIN_DATA = {
  ...
  flow: [
    { step: 1, title: "실행 시작", label: "실행 시작", refs: ["main"],
    ...
    { step: 2, title: "환경 변수 로드", label: "환경 변수 로드", refs: ["load_env", "find_env_file"],
    ...
    { step: 3, title: "언어 선택", label: "언어 선택", refs: ["select_language"],
    ...
    { step: 4, title: "대화 파일 로드", label: "대화 파일 로드", refs: ["load_dialog"],
    ...
    { step: 5, title: "화자별 음성 선택", label: "화자별 음성 선택", refs: ["get_speakers", "select_voice"],
    ...
    { step: 6, title: "번역", label: "번역", refs: ["translate_text"],
    ...
    { step: 7, title: "TTS 음성 합성", label: "TTS 음성 합성", refs: ["generate_tts", "wav_bytes_to_array"],
    ...
    { step: 8, title: "세그먼트 연결·저장", label: "세그먼트 연결·저장", refs: ["concatenate_segments"],
