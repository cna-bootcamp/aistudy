  ...
  flow: [
    {
      ...
      label: "의도 분류",
      refs: ["route", "scheduler_internals"],
    ...
    },
    {
      ...
      label: "단위 MAS 호출",
      refs: ["run_unit_node", "run_mas_handlers"],
    ...
    },
    {
      ...
      label: "글로벌 Supervisor",
      refs: ["supervisor_node", "budget", "budget_methods"],
    ...
    },
    {
      ...
      title: "최종 합성 (compose)",
      label: "최종 합성",
      refs: ["compose_node", "compose_helpers"],
