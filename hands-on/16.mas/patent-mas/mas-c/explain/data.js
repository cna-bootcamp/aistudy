  ...
  flow: [
    {
      ...
      title: "질문 입력 & 컨텍스트 확보",
      label: "컨텍스트 확보",
      refs: ["gather_context","gather_law_context"],
    ...
    },
    {
      ...
      title: "의견서 초안 작성",
      label: "초안 작성",
      refs: ["write_draft","draft_builders"],
    ...
    },
    {
      ...
      label: "게이트2: 인용검증",
      refs: ["verify_citations_node","verify_citations_async"],
    ...
    },
    {
      ...
      label: "재작성·승급",
      refs: ["decide_gate","rewrite_draft","escalate"],
