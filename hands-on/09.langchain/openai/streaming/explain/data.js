...
window.EXPLAIN_DATA = {
  ...
  flow: [
    ...
    { step: 2, title: "에이전트 준비", label: "에이전트 준비", refs: ["get_agent"],
    ...
    { step: 6, title: "히스토리 변환", label: "히스토리 변환", refs: ["build_history"],
    ...
    { step: 7, title: "스트리밍 실행", label: "스트리밍 실행", refs: ["stream_response"],
    ...
    { step: 9, title: "실시간 렌더링", label: "실시간 렌더링",
    ...
    { step: 10, title: "결과 표시 및 반복", label: "결과 표시·반복", refs: ["display_sidebar"],
